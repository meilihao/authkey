			...
			Langs: []TranslationRegisterElem{
				{
					...
					RegisterFn: func(ut ut.Translator) error {
						return ut.Add("checkMobile", i18n.TrKey(zh, "arg.mobile"), true) // see universal-translator for details, validator的formt占位符与golang fmt不一致
					},
				...
				},
				{
					Trans: enTrans,
					RegisterFn: func(ut ut.Translator) error {
						return ut.Add("checkMobile", i18n.TrKey(en, "arg.mobile"), true) // see universal-translator for details
					},
					TranslationFn: func(ut ut.Translator, fe validator.FieldError) string {
